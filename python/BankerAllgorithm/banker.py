...
class banker():
    ...
    def execute(self, processes, max_data, request_data):
        ...
        #self._show(req_processes, max, request, allocation, need)
        print('###当前初始状态:')
